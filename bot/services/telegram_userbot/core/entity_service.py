...
class EntityService:
    ...
    async def _join_private_chat(self, client: TelegramClient, source_link: str) -> Optional[TelegramEntity]:
        try:
    ...
    async def search_entities(self, client: TelegramClient, query: str, limit: int = 10) -> List[TelegramEntity]:
        try:
    ...
    async def verify_entity_access(self, client: TelegramClient, entity: TelegramEntity) -> bool:
        try:
