...
class PostConversionService:
    ...
    async def _safe_convert_post(self, raw_post: Dict, flow: FlowDTO) -> Optional[PostDTO]:
        try:
    ...
    async def _convert_single_post(self, raw_post: Dict, flow: FlowDTO) -> Optional[PostDTO]:
    ...
    def _set_post_metadata(self, post_dto: PostDTO, raw_post: Dict) -> PostDTO:
        ...
        update_data.update({
            ...
            'original_content': post_dto.original_content or raw_post.get('original_content', '')
        })
